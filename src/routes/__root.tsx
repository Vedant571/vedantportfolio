...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vedant Modi — Full-Stack Developer & AI Enthusiast" },
      ...
      { property: "og:title", content: "Vedant Modi — Full-Stack Developer & AI Enthusiast" },
      ...
      { name: "twitter:title", content: "Vedant Modi — Full-Stack Developer & AI Enthusiast" },
